...
$html1 = <<<EOF
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px; font-size:10px">
		<tr>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Cédula</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Nombre</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Médico</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Patologías</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Fecha de inicio</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Fecha de finalización</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Días de reposo</td>
			<td width="67.3px" style="border: 1px solid #666; background-color:#d50000; color:#fff">Observaciones</td>
...
$reposo = RepososController::impresionRepososController($item, $valor, $orden);
