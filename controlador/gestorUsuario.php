			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						echo '<br>
							<script>
								Materialize.toast("¡El usuario no está activo!", 5000, "rounded orange")
							</script>';
					...
					echo '<br>
						<script>
							Materialize.toast("¡Error al ingresar,  vuelve a intentarlo!", 5000, "rounded red")
						</script>';
					...
					echo'<script>
						...
						swal({
							  type: "error",
							  title: "¡Por favor no introducir caracteres especiales!",
